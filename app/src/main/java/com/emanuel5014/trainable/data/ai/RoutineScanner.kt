...
object RoutineScanPrompt {
    ...
    fun build(languageCode: String): String = """
...
JSON schema:
[{"name": "...", "sets": 3, "reps": "8-12", "rest_seconds": 120, "cardio_minutes": null}]
""".trim()
}
...
class RoutineScanner @Inject constructor(
    ...
    suspend fun scan(
        ...
        val response = engine.scanRoutineSheet(
            imageUri = imageUri,
            prompt = RoutineScanPrompt.build(languageCode),
        ...
        return parsed.map { item ->
            ...
            ScannedExerciseEntry(
                ...
                suggestedCategory = match?.categoria ?: "",
